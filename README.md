...
This project currently focuses on the R-89 model jukebox, because that's what I own.  However, it has slightly wider applicability.  Largely similar (perhaps identical) CCC circuit boards and evolving code was used for subsequent models for several years, such as the R-90, R-91, R-92, R-93 and R-94 (collectively "R-9X").  Some other collectors have shared EPROM dumps of other EPROMs in this series.  Future work may include disassembly of these later versions.
