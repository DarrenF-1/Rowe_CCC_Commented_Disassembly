...
Description of files:
  ...
  - R-93_CCC_schematic.png: an electronic schematic diagram of the CCC.  This is from an R-93, which is believed to be electronically identical (or nearly so) to the PCBs used for the entire R-89 thru R-94 series (as well as the R-88 video model). 
