...
> Note that this project relates specifically to the "CCC" used in th R-88 _video_ and R-89 through the R-94 models with CCC assembly part number 4-077730-XX and CCC PCB part number 6-09738-XX. It does *not* relate to the identially named "CCC" used in the earlier R-84 throuh R-89 (non-video) models, with CCC assembly P/N 6-08870-XX and CCC PCB P/N 6-08871-XX; _nor_ to the "CCC" used in the later CD-100 models, with CCC assembl P/N 4-08322-XX and PCB P/N 6-10311-XX.
